...
if ($this->data['errorcode'] !== null) {
    ...
    <div class="ui-tabs ui-widget ui-widget-content ui-corner-all" style="background: #f5f5f5;">
        ...
        <p><strong><?php echo htmlspecialchars($this->t($this->data['errorcodes']['title'][$this->data['errorcode']], $this->data['errorparams'])); ?></strong></p>

        <p><?php echo htmlspecialchars($this->t($this->data['errorcodes']['descr'][$this->data['errorcode']], $this->data['errorparams'])); ?></p>
    </div>
<?php
}
    ...
    <form action="?" method="post" name="f">
        <table>
            <tr>
                ...
                <td>
                    <label style="margin-top: 0.7rem;" for="username"><?php echo $this->t('{login:username}'); ?></label>
                </td>
                <td>
                    <input id="username" <?php echo ($this->data['forceUsername']) ? 'disabled="disabled"' : ''; ?>
                           type="text" name="username" <?php if (!$this->data['forceUsername']) { echo 'tabindex="1"'; } ?> value="<?php echo htmlspecialchars($this->data['username']); ?>"/>
                </td>
                <?php
                ...
                <td id="regular_remember_username">
                    <input type="checkbox" id="remember_username" tabindex="4"
                           ...
                           name="remember_username" value="Yes" style="margin-right: 0.7rem;" />
            ...
            ?>
            <tr>
                <td><label style="margin-top: 0.7rem;" for="password"><?php echo $this->t('{login:password}'); ?></label></td>
                <td>
